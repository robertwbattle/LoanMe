  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      if (parsedUser.wallet_address) {
        fetch(`/api/solana/balance/${parsedUser.wallet_address}`)
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8">
      <div className="z-10 w-full max-w-xl px-5 xl:px-0">
        <a target="_blank"
          href="https://twitter.com/intent/tweet?text=LoanMe%3A%20Best%20P2P%20microloan%20platform%20in%20the%20web%20http://loanme.nyc/"
